        ...
        <div class="col-sm-12">
          <div class="card">
            ...
            <div class="card-body" >
              ...
              <hr/>
              <div id="printMe" class="table-responsive-sm" style="overflow: auto;">
                <table class="table table-sm table-bordered table-condesed table-striped table-hover" style="min-width: 810px;">
                    <thead>
                      <tr>
                        <th>Service</th>
                        <th>Cleaner</th>
                    ...
                    <tbody>
                      ...
                      <tr v-else v-for="(d, index) in report_data" :key="index">
                        ...
                        <td>{{ d.cleaner_firstname }} {{ d.cleaner_middlename }} {{ d.cleaner_lastname }}</td>
                        <td>{{ d.day_desc }} {{ d.formated_start_time }} {{ d.formated_end_time }}</td>
                        <td>
...
export default {
    ...
    methods:{
      ...
      create_client_report(){
        axios.post(this.base_url + '/client_create_report', {
          from: this.from,
          to: this.to,
        }).then(({data}) => {
